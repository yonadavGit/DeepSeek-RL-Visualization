...
\begin{frame}
\eyebrow{Building Blocks \textperiodcentered\ 14}{}
...
{\normalsize\color{ink}PPO reuses one batch of rollouts for several update steps instead of resampling every time --- that's the whole point of the rewrite. But the exact-gradient guarantee from the last slide only holds right at $\theta=\theta_{\text{old}}$, where $\text{ratio}_t=1$. After a few of those update steps, $\theta$ has moved, and $\text{ratio}_t(\theta)$ can drift far from 1 for some tokens. Nothing in $L(\theta)=\text{ratio}_t(\theta)\cdot A_t$ stops that drift --- the objective just keeps rewarding it, even once the comparison it's built on, current policy versus old policy, is no longer a small, trustworthy difference.}
\par\vspace{10pt}
\begin{calloutwarm}
...
\begin{frame}
\eyebrow{Baselines \& PPO \textperiodcentered\ 19}{}
...
\begin{frame}
\eyebrow{Baselines \& PPO \textperiodcentered\ 20}{\S7.3.2}
...
% ================= 18 : PPO -- ASSEMBLED =================
\begin{frame}
\eyebrow{Baselines \& PPO \textperiodcentered\ 21}{\S7.3.1}
...
% ================= 19 : GRPO MECHANISM =================
\begin{frame}
\eyebrow{GRPO \textperiodcentered\ 24}{\S7.4.1}
...
% ================= 20 : GRPO -- ASSEMBLED =================
\begin{frame}
\eyebrow{GRPO \textperiodcentered\ 25}{\S7.4.2 / \S7.4.3}
...
% ================= 21 : APPROACH -- RLVR =================
\begin{frame}
\eyebrow{RLVR \textperiodcentered\ 26}{\S7.5}
\frametag{accentB}{Approach}
...
\begin{frame}
\eyebrow{DeepSeek-R1 \textperiodcentered\ 30}{}
...
% ================= 24 : IMPLEMENTATION =================
\begin{frame}[fragile]
\eyebrow{Implementation \textperiodcentered\ 35}{\S7.8\,--\,7.10}
...
% ================= 25 : SUMMARY =================
\begin{frame}
\eyebrow{Close \textperiodcentered\ 36}{\S7.15}
